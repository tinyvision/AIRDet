...
from airdet.base_models.losses.distill_loss import FeatureLoss
...
class Distiller:
    def __init__(self, stu_config, tea_config, args, is_train=True):
        # init function only defines some basic attr, other attrs like model, optimizer are built in
        # before_train methods.
        self.config = stu_config
        ...
        self.seed = stu_config.miscs.seed

        # logger
        logger.info("args info: {}".format(self.args))
        logger.info("stu config value:\n{}".format(self.config))
    ...
    def train(self, local_rank):
        ...
        ckpt_file_path = self.args.tea_ckpt
